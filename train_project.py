...
class train:
    def __init__(
        ...
        des="",
        day_of_travel="",
        seat_available_in_1AC=0,
        seat_available_in_2AC=0,
        seat_available_in_SL=0,
        fare_1ac=0,
        fare_2ac=0,
        fare_sl=0,
    ):
        ...
        self.seats = {
            "1AC": seat_available_in_1AC,
            "2AC": seat_available_in_2AC,
            "SL": seat_available_in_SL,
        }
    ...
    if pnr in ticket_dict:
        ...
        if prompt == "y":
            if logged_in:
                ...
                trains[ticket_dict[pnr].train_num].seats[
                    ticket_dict[pnr].coach
                ] += ticket_dict[pnr].ticket_num
...
def check_pnr(pnr=""):
    if pnr == "":
        ...
        print(
            "Train number:- ",
            ticket_dict[pnr].train_num,
            " Source:- ",
            trains[ticket_dict[pnr].train_num].src,
            " Destination:- ",
            trains[ticket_dict[pnr].train_num].des,
        )
...
t1 = train(
    "odisha", 12345, "12:34", "22:12", "ctc", "kgp", "Wed", 30, 23, 43, 2205, 320, 234
)
t2 = train(
    "howrah", 12565, "02:34", "23:12", "hwr", "kol", "Mon", 33, 4, 12, 3434, 435, 234
)
t3 = train(
    "bangalore", 22353, "11:56", "03:12", "ctc", "ban", "Fri", 33, 24, 77, 455, 325, 533
)
...
def menu():
    ...
    func = {
        ...
        2: cancel_ticket,
        3: check_pnr,
        4: check_seat_availabilty,
        5: create_new_acc,
        6: check_prev_bookings,
        7: login,
        8: end,
    }
